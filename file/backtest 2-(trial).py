...
strategy_dropdown = OptionMenu(root, strategy_var, "Strategy 1", "Strategy 2", command=update_dashboard)
strategy_dropdown.pack(pady=10)

# Label for displaying Profit/Loss result
result_label = Label(root, text="Profit/Loss: $0.00", font=("Helvetica", 12))
